...
# Exemple 
list_x = [[1, 1.1], [2, 2.1], [3, 3.1]]
list_y = [[1, 1.2], [2, 2.2], [3, 3.2]]
list_theta = [[0.1, 0.15], [0.2, 0.25], [0.3, 0.35]]
list_vg = [[0.1, 0.15], [0.2, 0.25], [0.3, 0.35]]
list_vd = [[0.1, 0.15], [0.2, 0.25], [0.3, 0.35]]
list_dt = [0.0, 1.0, 2.0]
...
def plot_position_orientation_comparaison(list_x, list_y, list_theta, list_vg, list_vd, list_dt) :
  ...
  # list_x
  ax1.plot(list_dt, x_n, marker='o', label='x_n', linestyle='--', markersize=2)
  ax1.plot(list_dt, x_real, marker='o', label='x_real', markersize=2)
  ax1.set_title('Position x comparaison')
  ax1.set_xlabel('Position x (m)', fontsize='smaller')
  ax1.set_ylabel('Time (s)', fontsize='smaller')
  ax1.legend()

  # list_y
  ax2.plot(list_dt, y_n, marker='o', label='y_n', linestyle='--', markersize=2)
  ax2.plot(list_dt, y_real, marker='o', label='y_real', markersize=2)
  ...
  # list_theta
  ax3.plot(list_dt, theta_n, marker='o', label='theta_n', linestyle='--', markersize=2)
  ax3.plot(list_dt, theta_real, marker='o', label='theta_real', markersize=2)
  ...
  # list_vg
  ax4.plot(list_dt, vg_n, marker='o', label='vg_n', linestyle='--', markersize=2)
  ax4.plot(list_dt, vg_real, marker='o', label='vg_real', markersize=2)
  ...
  # list_vd
  ax5.plot(list_dt, vd_n, marker='o', label='vd_n', linestyle='--', markersize=2)
  ax5.plot(list_dt, vd_real, marker='o', label='vd_real', markersize=2)
