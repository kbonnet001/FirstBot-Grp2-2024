...
# t1 = time.time()
# image = img.imread("pic.jpg")
# plt.imshow(image)
# plt.show()
# print("temps de traitement :", round(time.time() - t1, 3))
...
try:
  while(True):
    ...
    # theta_line = tools.calculate_theta_line_cam(sampling_h2, sampling_2_center, h, center_x)
    # print(theta_line)
